...
// The diagnostic fields are a large bag of raw, external WS-protocol flags never branched
// on elsewhere in this codebase (only stored and, eventually, serialized to disk) - typed
// as `unknown` rather than guessing at a precise shape for external data this class
// doesn't interpret.
export interface HMIPWSDiagnosticChannelParams {
    deviceId: string;
    index: number;
    groupIndex: number;
    label: string;
    ...
    unreach?: unknown;
    lowBat?: unknown;
    routerModuleEnabled?: unknown;
    multicastRoutingEnabled?: unknown;
    routerModuleSupported?: unknown;
    rssiDeviceValue?: unknown;
    rssiPeerValue?: unknown;
    configPending?: unknown;
    dutyCycle?: unknown;
    deviceOverloaded?: unknown;
    coProUpdateFailure?: unknown;
    coProFaulty?: unknown;
    coProRestartNeeded?: unknown;
    deviceUndervoltage?: unknown;
    deviceOverheated?: unknown;
    temperatureOutOfRange?: unknown;
    devicePowerFailureDetected?: unknown;
    busConfigMismatch?: unknown;
    powerShortCircuit?: unknown;
    shortCircuitDataLine?: unknown;
    profilePeriodLimitReached?: unknown;
    mountingOrientation?: unknown;
    controlsMountingOrientation?: unknown;
    displayMountingOrientation?: unknown;
    displayMode?: unknown;
    invertedDisplayColors?: unknown;
    temperatureHumiditySensorError?: unknown;
    temperatureHumiditySensorCommunicationError?: unknown;
    particulateMatterSensorError?: unknown;
    particulateMatterSensorCommunicationError?: unknown;
    sensorError?: unknown;
    sensorCommunicationError?: unknown;
    displayContrast?: unknown;
    lockJammed?: unknown;
    deviceDriveError?: unknown;
    deviceDriveModeError?: unknown;
    deviceCommunicationError?: unknown;
    daliBusState?: unknown;
    deviceOperationMode?: unknown;
    defaultLinkedGroup?: unknown;
    operationDays?: unknown;
    deviceAliveSignalEnabled?: unknown;
    altitude?: unknown;
    mountingModuleError?: unknown;
    inputLayoutMode?: unknown;
    switchChannelMode?: unknown;
    frostProtectionError?: unknown;
    frostProtectionErrorAcknowledged?: unknown;
    valveFlowError?: unknown;
    valveWaterError?: unknown;
    noDataFromLinkyError?: unknown;
    dataDecodingFailedError?: unknown;
    ticVersionError?: unknown;
    deviceCanBusError?: unknown;
    notRechargeableBattery?: unknown;
 ...
 */
export class HMIPWSDiagnosticChannel extends HMIPWSFunctionalChannel {
    unreach?: unknown;
    lowBat?: unknown;
    routerModuleEnabled?: unknown;
    multicastRoutingEnabled?: unknown;
    ...
    static FIELDS: (keyof HMIPWSDiagnosticChannelParams)[] = [
    ...
    constructor(functionalChannelType: string, params: HMIPWSDiagnosticChannelParams) {
        super(
    ...
    static baseFieldsFromJson(json: Record<string, any>): HMIPWSDiagnosticChannelParams {
        const result: Record<string, unknown> = {};
        for (const field of HMIPWSDiagnosticChannel.FIELDS) {
            result[field] = json[field];
        }
        return result as unknown as HMIPWSDiagnosticChannelParams;
    }
}
